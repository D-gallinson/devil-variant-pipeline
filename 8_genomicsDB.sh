#!/bin/bash
#SBATCH --job-name=8_genomicsDB_host
#SBATCH --partition=margres_2020
#SBATCH --qos=margres20
#SBATCH --mail-user=dgallinson@usf.edu
#SBATCH --mail-type=END,FAIL
#SBATCH --output=/work_bgfs/d/dgallinson/scripts/master/logs/Capture4/out/8_genomicsDB_host.out
#SBATCH --error=/work_bgfs/d/dgallinson/scripts/master/logs/Capture4/err/8_genomicsDB_host.err
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
sample_type="host"  #Set to "host" or "tumor"
