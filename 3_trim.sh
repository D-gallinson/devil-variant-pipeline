...
#SBATCH --output=/work_bgfs/d/dgallinson/scripts/master/logs/Capture5/out/3_trim/%a.out
#SBATCH --error=/work_bgfs/d/dgallinson/scripts/master/logs/Capture5/err/3_trim/%a.err
#SBATCH --ntasks=1
#SBATCH --nodes=1
